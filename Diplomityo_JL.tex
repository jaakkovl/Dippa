...
\subsubsection{Liiketoimintaprosessien kehittäminen}

Yritykset kehittävät liiketoimintaprosessejaan kasvattaakseen suorituskykyään markkinoilla. Liiketoimintaprosessin suorituskykyä voidaan kasvattaa sen sisältämiä toimintoja tehostamalla, pienentämällä kustannuksia tai luomalla sen avulla uutta arvoa asiakkaille. Tavoitteena on tuottaa paras mahdollinen lopputulos mahdollisimman pienillä resursseilla. Resursseja ovat esimerkiksi aika, raha, materiaalit ja työvoima. \citep{leanit} \\

Ajan kuluessa, asiakkaiden tarpeet muuttuvat ja markkinoilla toimivat kilpailijat kehittävät liiketoimintaprosessejaan yhä kustannustehokkaammiksi. Siksi liiketoimintaprosessien kehittäminen on jatkuvaa tomintaa, jolla varmistetaan yrityksen valmiudet vastata muuttuviin asiakastarpeisiin ja säilymään kilpailukykyisenä markkinoilla. Edellytyksenä kuitenkin on prosessikulttuurin olemassaolo, jolloin voidaan olettaa toiminnan perustuvan prosessien käyttöön, mittaamiseen ja niiden avulla johtamiseen. \citep{teollisuustalous}\\

Prosessijohtamisessa huomio kiinnitetään yrityksen kannalta tärkeimpiin arvoa tuottaviin prosesseihin. Tällöin prosessille vastuutettu omistaja on vastuussa kehittämistoimenpiteistä. Liiketoimintaprosessien kehittämisen lähtökohtana on ymmärrys nykytilasta, tavoitetilasta ja näiden kahden tilan erojen tunnistamisesta. Kun näiden kahden tilan väliset erottavat tekijät on tunnistettu, pystytään priorisoimaan kehitystä vaativat osa-alueet. Nykytilan ymmärtäminen tarkoittaa prosessiketjun todellisten toimintamallien tuntemista, jolloin voidaan nähdä arvoa tuottavat ja tuottamattomat vaiheet. Tavoitetila on kuvaus niistä ominaisuuksista tai laatuvaatimuksista, jotka ohjaavat prosessin kehittämisen toimenpiteitä. \citep{leanit}\\
...
%Prosessijohtamisen näkökulmasta yritykset kilpailevat markkinoilla liiketoimintaprosessiensa suorituskyvyllä. Liiketoimintaprosessin suorituskykyyn vaikuttaa sen tuottama lisäarvo asiakkaalle ja kustannus, jolla lisäarvo tuotettiin. Ajan kuluessa, asiakkaiden tarpeet muuttuvat ja yritykset kehittävät liiketoimintaprosessejaan yhä kustannustehokkaammiksi. Siksi liiketoimintaprosessien jatkuva kehittäminen kasvattaa yrityksen valmiuksia parempaan ja tuottavampaan liiketoimintaan. Edellytyksenä kuitenkin on prosessikulttuurin olemassaolo, jolloin voidaan olettaa toiminnan perustuvan prosessien käyttöön, mittaamiseen ja niiden avulla johtamiseen. \citep{teollisuustalous} \\
...
Kirjallisuudessa nousee esiin useita eri näkökulmia liiketoimintaprosessien kehittämiseen. Tässä alaluvussa on tarkoitus esitellä näitä näkökulmia ja liiketoimintaprosessin kehittämiseen liittyviä konsepteja.\\

\textbf{Laatujohtaminen (Total Quality Management)}\\
...
Laatuajattelussa korostuu asiakaslähtöisyys, henkilöstön sitouttaminen ja kouluttaminen sekä laadun jatkuva parantaminen \citep{teollisuustalous}.\\

\textbf{Laaja liiketoimintaprosessin kehittämismalli (Business Process Management)}\\

Laaja liiketoimintaprosessin kehittämismalli keskittyy prosessiorganisaation luomiseen, jossa toimintaa johdetaan liiketoimintaprosesseja kehittämällä. Kaiken perustana on liiketoimintaprosessien toimintojen ja niiden välisten riippuvaisuuksien kuvaaminen, jonka jälkeen niitä voidaan analysoida ja kehittää.
...
\textbf{Liiketoimintaprosessin uusiminen (Business Process Re-engineering)}\\
