...
Tässä työssä pohditaan miten automatisoidaan kompleksin asiakaspalvelujärjestelmän tilaus-, toimitus- ja laskutusprosessi Telian nykyisessä liiketoimintakontekstissa. Kompleksi tarkoittaa tässä yhteydessä runsasta räätälöinnin ja konfiguroinnin määrää järjestelmän tuotantoon saattamisessa.
Automatisointia pohditaan jakamalla prosessi osiin, ja järjestämällä osaset priorisoituun listaan automatisoinnin toteuttamiseksi. Lisäksi työ ottaa kantaa automatisoinnin suorittavaan teknologiaan, ja vaihtoehtoisiin menetelmiin tehostaa prosessia tilanteissa, joissa automaatio ei ole mahdollinen. Prosessin jakoon osiin, järjestämiseen ja aikatauluun, jossa automatisointi tulisi suorittaa, vaikuttaa liiketoiminnan tavoitteet, asiakastarpeet ja kyvykyydet hyödyntää teknologioita.\\

Trendit:\\
Automaatio, RPA, Lean, Nopeasti pilvestä yms. \\

Nykytilanne:\\
Tämän vuoksi ollaan kuitenkin missä ollaan, koska...\\

Teoreettinen viitekehys:\\
BPA, RPA, Lean, ...
Tämä onnistuu hyödyntämällä teoriaa liiketoimintaprosessien automatisoinnista, ohjelmistorobotiikasta ja Lean-ajattelusta nykyisessä liiketoimintakontekstissa. Tämä tarkoittaa sitä, että osa prosessista \\
